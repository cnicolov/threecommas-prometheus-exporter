 ...
 *
 * Values: quoteCurrency,baseCurrency
 */

enum class ProfitCurrencyEnum(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is ProfitCurrencyEnum) "$data" else null
